/ *
    ...
    Descrição:
    Converte quase qualquer formato de data em um valor AAAAMMDDHH24MISS.

    Parâmetros:
        str - um carimbo de data/hora como uma string

    Retorna:
        Um valor YYYYMMDDHH24MISS válido que pode ser usado por FormatTime, EnvAdd e outros comandos de tempo.
